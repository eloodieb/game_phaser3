function create() {
  ...
  // // petits qui montre vers la gauche
  ...
  // // positionnement de pawprint/empreinte
...
//Création du  Man qui se déplace
  ...
  function collectStar (player, pawprint, dogBone, dogBowl, dogHouse, tag)
  {
    ...
    {
      // positionnement de chien sur le dernier plateforme
